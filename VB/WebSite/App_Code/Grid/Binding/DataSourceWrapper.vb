...
Namespace DevExpress.Web
	...
	Public Class ObjectDataSourceWrapper
		...
		Protected Overrides Function GetView(ByVal viewName As String) As DataSourceView
			If (viewName IsNot Nothing) AndAlso ((viewName.Length = 0) OrElse String.Equals(viewName, "DefaultView", StringComparison.OrdinalIgnoreCase)) Then
				Return Me.GetView()
			End If
	...
	Public Class ObjectDataSourceWrapperView
		...
		Protected Overrides Function ExecuteSelect(ByVal arguments As DataSourceSelectArguments) As IEnumerable
			...
			If Me.dataSource_Renamed IsNot Nothing Then
		...
		Public Overrides ReadOnly Property CanUpdate() As Boolean
			Get
				Return DataSource IsNot Nothing
			End Get
		End Property
		...
		Protected Function ExecuteViewSelect(ByVal ds As DataSourceSelectArguments, ByVal applySorting As Boolean) As IEnumerable
			If applySorting AndAlso sortInfo IsNot Nothing AndAlso sortInfo.Count > 0 Then
		...
		Protected Overridable Sub PopulateList(ByVal index As Integer)
			...
			End If
			DataRecords.Clear()
			Dim ds As New DataSourceSelectArguments(index, owner.PageSize)
		...
		Private Sub PopulateDataSourceInfo()
			...
			Else
				...
				Dim props(columns.Length - 1) As PropertyDescriptor
		...
		Private Function GetProperties(ByVal collection As PropertyDescriptorCollection) As PropertyDescriptorCollection
			Dim res(collection.Count - 1) As PropertyDescriptor
...
#Region "IListServer Members"
        ...
        Private Property FilterCriteria() As DevExpress.Data.Filtering.CriteriaOperator Implements IListServer.FilterCriteria
            ...
            End Set
        End Property
        Private Function FindIncremental(ByVal column As PropertyDescriptor, ByVal value As String, ByVal startIndex As Integer, ByVal searchUp As Boolean) As Integer Implements IListServer.FindIncremental
            Return -1
        End Function
